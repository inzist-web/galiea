  ...
  return (
    <section className="advantages">
      ...
      <div className="advantages__card advantages__card_size_long">
        <p className="advantages__text">Вы не несете затрат на оборудование рабочих мест бухгалтеров, закупку правовых баз данных и бухгалтерских программ, а также экономите время и деньги на подборе и обучении кадров.</p>
      </div>
    </section>
  )
}